...
impl Vec3 {
    ...
    pub fn format_color(self) -> String {
        ...
        // let ir = 256.0 * (self[0] / (sample_per_pixel as f64)).clamp(0.0, 0.999);
        // let ig = 256.0 * (self[1] / (sample_per_pixel as f64)).clamp(0.0, 0.999);
        // let ib = 256.0 * (self[2] / (sample_per_pixel as f64)).clamp(0.0, 0.999);
        // format!("{} {} {}", ir, ig, ib)
    }
